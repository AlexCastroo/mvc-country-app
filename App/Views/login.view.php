    ...
    <div class="container text-center flex flex-col w-1/4 mx-auto my-10 px-10 py-10 bg-emerald-100 rounded-lg border-2 border-emerald-200">
        <h1 class="mb-4 text-2xl text-center font-extrabold leading-none tracking-tight text-emerald-400 md:text-2xl lg:text-6xl dark:text-white">Login</h1>


    <form method="POST" action="http://localhost/mvc-country-app/Public/user/login" class="max-w-sm mx-auto">
        <div>
